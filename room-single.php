...
<html lang="en">
  ...
  <body>
			...
			<div class="container">
				<div class="row justify-content-between">
						<div class="col d-flex align-items-center">
							<p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">+00 1234 567</a> or <span class="mailus">email us:</span> <a href="#">aviduwitharana@gmail.com</a></p>
						</div>
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="index.php">Avidz<span>Stays</span></a>
			...
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 wrap-about">
						...
						<h2>The most recommended AvidzStays</h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						<h2 class="footer-heading"><a href="#" class="logo">AvidzStays</a></h2>
